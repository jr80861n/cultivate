              ...
              <div className="max-w-6xl">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center gap-10">
                  ...
                  <div className="flex flex-wrap gap-6">
                    <Link href="/signup" className="flex items-center justify-center rounded-full h-16 px-12 bg-primary hover:bg-white hover:text-black text-white font-black uppercase tracking-[0.3em] text-xs transition-all duration-500 neon-border hover:shadow-[0_0_40px_rgba(255,255,255,0.8)] magnetic-btn interactive-hover">
                      Register
                    </Link>
                    <button className="rounded-full h-16 px-12 border border-white/30 hover:border-primary hover:text-primary text-white font-black uppercase tracking-[0.3em] text-xs transition-all duration-500 flex items-center gap-4 backdrop-blur-sm group magnetic-btn interactive-hover">

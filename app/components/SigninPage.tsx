    ...
    return (
        <div className="bg-[#f7f6f8] dark:bg-[#191022] text-slate-800 dark:text-slate-200 font-display min-h-screen flex items-center justify-center overflow-hidden">
            <div className="w-full h-screen flex relative overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 bg-[#f7f6f8] dark:bg-[#191022] flex flex-col items-center justify-center p-8 lg:p-16 relative">
                    ...
                    <div className="w-full max-w-md z-10 relative">
                        ...
                        <form className={`space-y-6 ${status}`} onSubmit={handleSubmit}>
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <Link className="text-slate-400 hover:text-[#7f13ec] transition-colors link-underline pb-0.5" href="#">Forgot password?</Link>
                            </div>
                        ...
                        <div className="relative my-10">
                            ...
                            <div className="relative flex justify-center text-xs uppercase tracking-wider">
                                <span className="bg-[#f7f6f8] dark:bg-[#191022] px-4 text-slate-500">Or continue with</span>
                            </div>
                        </div>

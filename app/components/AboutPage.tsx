                ...
                <section className="relative py-48 px-6 bg-gradient-to-br from-primary via-primary-dark to-[#2e1065] overflow-hidden">
                    <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 reveal-element stagger-2">
                            <button className="rounded-full bg-white text-primary-dark px-12 py-5 font-black uppercase tracking-[0.2em] text-lg hover:bg-black hover:text-white transition-all hover:scale-105 shadow-[0_10px_40px_rgba(0,0,0,0.3)]">
                                Schedule Audition
                            </button>
                            <button className="rounded-full border-2 border-white text-white px-12 py-5 font-black uppercase tracking-[0.2em] text-lg hover:bg-white hover:text-primary-dark transition-all hover:scale-105 bg-white/10 backdrop-blur-sm">
                                Studio Tour
                            </button>
                        </div>
                    </div>

    ...
    return (
        <div className="bg-[#f7f6f8] dark:bg-[#020617] text-slate-800 dark:text-slate-200 font-display min-h-screen flex items-center justify-center overflow-hidden">
            <div className="w-full h-screen flex relative overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 bg-[#f7f6f8] dark:bg-[#020617] flex flex-col items-center justify-center p-8 lg:p-16 relative overflow-y-auto">
                    ...
                    <div className="w-full max-w-md z-10 relative mt-16 sm:mt-0">
                        ...
                        <form className={`space-y-5 ${status}`} onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="h-1 w-full bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                                    <div className={`h-full strength-meter-bar transition-all duration-300 ${strength.color} hover:shadow-[0_0_10px_rgba(4, 120, 87,0.5)]`} style={{ width: strength.width }}></div>
                                </div>
                            ...
                            <div className="flex items-start space-x-2 pt-2">
                                ...
                                <label className="text-sm text-slate-500 dark:text-slate-400 cursor-pointer select-none" htmlFor="terms">
                                    I agree to the <Link className="text-[#047857] hover:text-[#9d4af2] link-underline pb-0.5" href="#">Terms of Service</Link> and <Link className="text-[#047857] hover:text-[#9d4af2] link-underline pb-0.5" href="#">Privacy Policy</Link>.
                                </label>
                            </div>
                        ...
                        <div className="relative my-8">
                            ...
                            <div className="relative flex justify-center text-xs uppercase tracking-wider">
                                <span className="bg-[#f7f6f8] dark:bg-[#020617] px-4 text-slate-500">Or register with</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                                ...
                                <Link className="text-[#047857] hover:text-[#9d4af2] font-medium transition-colors link-underline pb-0.5 ml-1" href="/signin">Sign in</Link>
                            </p>
                        </div>
                    </div>

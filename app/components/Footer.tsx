              ...
              <div className="lg:col-span-3">
                ...
                <div className="flex flex-col gap-8 text-slate-500">
                  <div className="relative flex items-start gap-4 group cursor-pointer" onClick={() => setShowMapOptions(!showMapOptions)}>
                    ...
                    {showMapOptions && (
                      <div className="absolute top-full left-10 mt-2 bg-[#0f031b] border border-primary/50 rounded-lg p-2 shadow-[0_10px_30px_rgba(188,19,254,0.3)] z-50 flex flex-col gap-1 min-w-[200px]" onClick={(e) => e.stopPropagation()}>
                        <a 
                  ...
                  <div className="relative flex items-center gap-4 group cursor-pointer" onClick={() => setShowEmailOptions(!showEmailOptions)}>
                    ...
                    {showEmailOptions && (
                      <div className="absolute bottom-full left-10 mb-2 bg-[#0f031b] border border-primary/50 rounded-lg p-2 shadow-[0_10px_30px_rgba(188,19,254,0.3)] z-50 flex flex-col gap-1 min-w-[200px]" onClick={(e) => e.stopPropagation()}>
                        <a 

  ...
  return (
    <>
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,var(--tw-gradient-stops))] from-emerald-600/5 via-transparent to-transparent opacity-50"></div>
      ...
      <div className="relative z-10 flex h-auto min-h-screen w-full flex-col">
        <header className="sticky top-0 z-[100] flex items-center justify-between border-b border-white/5 bg-[#1a052b]/80 backdrop-blur-xl px-6 md:px-10 py-5 transition-all duration-300">
          <Link href="/" className="flex items-center gap-3 group cursor-pointer">
            <div className="flex size-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary-light to-primary shadow-[0_0_20px_rgba(4, 120, 87,0.5)] group-hover:scale-110 transition-transform duration-300">
              <span className="material-symbols-outlined !text-[24px]">music_note</span>
            </div>
            <h2 className="text-white text-xl font-black tracking-tighter uppercase drop-shadow-[0_0_10px_rgba(16, 185, 129,0.5)] group-hover:text-primary-light transition-colors">Cultivate</h2>
          </Link>
        ...
        <main className="flex-1">
          <section className="relative w-full px-6 md:px-10 pt-12 pb-20 max-w-7xl mx-auto perspective-1000">
            <div className="tilt-card relative overflow-hidden rounded-[3rem] border border-white/10 bg-cover bg-center min-h-[600px] flex items-center p-8 md:p-20 shadow-[0_20px_60px_rgba(0,0,0,0.5)] group" style={{ backgroundImage: 'linear-gradient(to right, rgba(2, 6, 23, 0.95) 30%, rgba(4, 120, 87, 0.1) 100%), url("https://lh3.googleusercontent.com/aida-public/AB6AXuDWMKhlMpSOu5CPW0MAlCQ39DTLA0uCpT7M3DdHXyiYMhjqtOxJ-mFDvgA-JVZ8Je5-6GD5_NXYd4dSlHtLA4Qj9S6dT4Anq8Zm7UR2oxs0FAM-9Qh3SirrTJcyXpUmzMQnRyTSJmufg0D--wLy8lCB1FrV3CPvcWo9sYW7Gw47-8hm2FbAFcUo00TqhWljFWRKkJeeCnm6MBX5a3haoRgcola6GXgRM6ra5QGuM9ALH9hF7zlgQX1XTmn-ztgrbYoheVSStX_CJ-Le")', transformStyle: 'preserve-3d' }}>
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle_at_center,rgba(16, 185, 129,0.3),transparent_60%)] animate-pulse"></div>
              ...
              <div className="tilt-content relative z-10 max-w-2xl">
                <div className="flex items-center gap-3 mb-8 reveal stagger-1 active">
                  <span className="w-12 h-[2px] bg-primary-light shadow-[0_0_10px_#10b981]"></span>
                ...
                <h1 className="reveal stagger-2 active text-6xl md:text-8xl font-black mb-8 leading-[0.9] tracking-tighter text-white drop-shadow-2xl">
                  THE <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-primary-light to-emerald-400 animate-pulse-glow">EVOLUTION</span>
                </h1>
                <p className="reveal stagger-3 active text-xl text-emerald-100/80 mb-12 leading-relaxed font-light max-w-lg">
                ...
                <div className="flex flex-wrap gap-5 reveal stagger-3 active">
                  <button className="register-btn h-16 px-12 rounded-full bg-white text-primary-dark font-black text-lg hover:bg-emerald-50 transition-all hover:scale-105 shadow-[0_0_30px_rgba(255,255,255,0.2)] relative overflow-hidden flex items-center justify-center">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 pb-32 space-y-32">
            <section className="relative" style={{ display: (activeFilter === 'ALL' || activeFilter === 'BALLET' || activeFilter === 'URBAN' || activeFilter === 'CONTEMPORARY') ? '' : 'none' }}>
              <div className="absolute top-20 right-[-10%] w-[600px] h-[600px] bg-[radial-gradient(circle_at_center,rgba(16, 185, 129,0.1),transparent_60%)] pointer-events-none"></div>
              <div className="absolute bottom-[-10%] left-[-10%] w-[800px] h-[800px] bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.05),transparent_60%)] pointer-events-none"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 perspective-1000">
                <div className="tilt-card reveal stagger-1 group flex flex-col bg-card-dark/40 backdrop-blur-sm rounded-[2.5rem] overflow-hidden border border-white/5 hover:border-primary-light/40 transition-all duration-300 hover:shadow-[0_20px_50px_rgba(4, 120, 87,0.15)] relative" style={{ display: (activeFilter === 'ALL' || activeFilter === 'BALLET') ? '' : 'none' }}>
                  ...
                  <div className="p-10 flex flex-col flex-1 relative bg-gradient-to-b from-transparent to-[#0f172a] tilt-content">
                    ...
                    <p className="text-emerald-200/60 text-sm leading-relaxed mb-10 flex-1 transform translate-z-10">Precision meets artistic expression. We focus on posture, French terminology, and building core strength from day one.</p>
                ...
                <div className="tilt-card reveal stagger-2 group flex flex-col bg-card-dark/40 backdrop-blur-sm rounded-[2.5rem] overflow-hidden border border-white/5 hover:border-primary-light/40 transition-all duration-300 hover:shadow-[0_20px_50px_rgba(4, 120, 87,0.15)] relative mt-0 md:mt-10 lg:mt-0" style={{ display: (activeFilter === 'ALL' || activeFilter === 'URBAN') ? '' : 'none' }}>
                  ...
                  <div className="p-10 flex flex-col flex-1 relative bg-gradient-to-b from-transparent to-[#0f172a] tilt-content">
                    ...
                    <p className="text-emerald-200/60 text-sm leading-relaxed mb-10 flex-1">High-impact exploration of urban roots. From old school fundamentals to cutting-edge freestyle choreography.</p>
                    <div className="flex items-center justify-between border-t border-white/10 pt-6 mt-auto">
                      <div className="flex flex-col">
                        <span className="text-primary-light text-[10px] uppercase font-black tracking-widest">SCHEDULE</span>
                ...
                <div className="tilt-card reveal stagger-3 group flex flex-col bg-card-dark/40 backdrop-blur-sm rounded-[2.5rem] overflow-hidden border border-white/5 hover:border-primary-light/40 transition-all duration-300 hover:shadow-[0_20px_50px_rgba(4, 120, 87,0.15)] relative mt-0 md:mt-20 lg:mt-0" style={{ display: (activeFilter === 'ALL' || activeFilter === 'CONTEMPORARY') ? '' : 'none' }}>
                  ...
                  <div className="p-10 flex flex-col flex-1 relative bg-gradient-to-b from-transparent to-[#0f172a] tilt-content">
                    ...
                    <p className="text-emerald-200/60 text-sm leading-relaxed mb-10 flex-1">Blending modern, jazz, and lyrical techniques. Focus on floor work, dynamic shifts, and emotional depth.</p>
                    <div className="flex items-center justify-between border-t border-white/10 pt-6 mt-auto">
                      <div className="flex flex-col">
                        <span className="text-primary-light text-[10px] uppercase font-black tracking-widest">SCHEDULE</span>
            ...
            <section className="reveal" style={{ display: (activeFilter === 'ALL' || activeFilter === 'ELITE') ? '' : 'none' }}>
              <div className="relative overflow-hidden rounded-[4rem] bg-[#0f172a] border border-white/10 p-1 group shadow-[0_0_80px_rgba(4, 120, 87,0.1)] hover:shadow-[0_0_100px_rgba(4, 120, 87,0.2)] transition-shadow duration-500">
                <div className="absolute -top-40 -right-40 w-[800px] h-[800px] bg-[radial-gradient(circle_at_center,rgba(16, 185, 129,0.1),transparent_60%)] group-hover:bg-[radial-gradient(circle_at_center,rgba(16, 185, 129,0.2),transparent_60%)] transition-all duration-1000"></div>
                <div className="absolute -bottom-40 -left-40 w-[600px] h-[600px] bg-[radial-gradient(circle_at_center,rgba(16,185,129,0.1),transparent_60%)]"></div>
                <div className="relative bg-card-dark/80 rounded-[3.9rem] p-8 md:p-20 flex flex-col lg:flex-row gap-20 items-center overflow-hidden">
                  <div className="lg:w-1/2 space-y-10 z-10">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 flex items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-primary-dark border border-primary-light/30 text-white shadow-[0_0_20px_rgba(16, 185, 129,0.4)] animate-bounce-slow">
                        <span className="material-symbols-outlined !text-[36px]">workspace_premium</span>
                      </div>
                      <span className="text-primary-light font-black tracking-[0.4em] uppercase text-xs drop-shadow-[0_0_5px_rgba(16, 185, 129,0.8)]">Audition Exclusive</span>
                    </div>
                    <h2 className="text-5xl md:text-7xl font-black leading-[0.9] tracking-tighter">NXTLVL <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-light via-emerald-300 to-white">PRO ELITE</span></h2>
                    <p className="text-xl text-emerald-200/80 leading-relaxed font-light">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:border-primary-light/50 transition-all hover:bg-white/10 cursor-default">
                        ...
                        <p className="text-xs text-emerald-300 mt-1">6 National Events Yearly</p>
                      </div>
                      <div className="p-6 rounded-3xl bg-white/5 border border-white/10 hover:border-primary-light/50 transition-all hover:bg-white/10 cursor-default">
                        ...
                        <p className="text-xs text-emerald-300 mt-1">Monthly Pro Workshops</p>
                      </div>
                    </div>
                    <div className="flex flex-wrap gap-6 pt-4">
                      <button className="register-btn h-16 px-12 rounded-full bg-gradient-to-r from-primary to-primary-light hover:brightness-110 text-white font-black transition-all shadow-[0_0_30px_rgba(4, 120, 87,0.3)] hover:-translate-y-1 relative overflow-hidden flex items-center justify-center w-full sm:w-auto">
                    ...
                    <div className="tilt-card h-full w-full">
                        <div className="absolute inset-0">
                            <Image
                                ...
                                alt="Dancers silhouetted against dramatic emerald lighting" 
                                className="w-full h-full object-cover opacity-80 mix-blend-luminosity scale-105" 
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-[#0f0f12] via-[#047857]/20 to-transparent"></div>
                        </div>
            ...
            <section className="relative" style={{ display: (activeFilter === 'ALL' || activeFilter === 'BALLET' || activeFilter === 'CONTEMPORARY') ? '' : 'none' }}>
              <div className="mb-16 reveal origin-left">
                <div className="inline-flex items-center gap-4 bg-background-layer-2/90 backdrop-blur-xl p-6 rounded-2xl border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.4)]">
                  <div className="w-2 h-12 bg-gradient-to-b from-emerald-500 to-emerald-600 shadow-[0_0_15px_#10b981]"></div>
                  <div>
                    <h2 className="text-4xl md:text-5xl font-black tracking-tighter uppercase text-white">Seasonal Intensives</h2>
                    <p className="text-emerald-300 text-sm font-bold tracking-widest uppercase mt-1">Technical Deep Dives • Holiday Series</p>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 perspective-1000">
                <div className="tilt-card reveal stagger-1 flex flex-col sm:flex-row bg-background-layer-1/60 rounded-[2.5rem] overflow-hidden border border-white/5 hover:border-primary-light/40 transition-all duration-700 group relative" style={{ display: (activeFilter === 'ALL' || activeFilter === 'CONTEMPORARY') ? '' : 'none' }}>
                  ...
                  <div className="p-10 sm:w-3/5 flex flex-col justify-center relative bg-gradient-to-l from-[#1e293b] to-transparent">
                    ...
                    <p className="text-emerald-200/60 text-sm leading-relaxed mb-8">A 3-week immersive experience focusing on creation, collaboration, and final stage production.</p>
                ...
                <div className="tilt-card reveal stagger-2 flex flex-col sm:flex-row bg-background-layer-1/60 rounded-[2.5rem] overflow-hidden border border-white/5 hover:border-primary-light/40 transition-all duration-700 group relative" style={{ display: (activeFilter === 'ALL' || activeFilter === 'BALLET') ? '' : 'none' }}>
                  ...
                  <div className="p-10 sm:w-3/5 flex flex-col justify-center relative bg-gradient-to-l from-[#1e293b] to-transparent">
                    ...
                    <p className="text-emerald-200/60 text-sm leading-relaxed mb-8">Classical variations and pointework intensive for aspiring ballet professionals and soloists.</p>
                    <Link className="inline-flex items-center gap-2 text-white font-black text-xs tracking-widest uppercase group-hover:text-primary-light transition-colors" href="#">
                      LEARN MORE <span className="material-symbols-outlined text-primary-light transition-transform group-hover:translate-x-2">arrow_right_alt</span>
                    </Link>
                  </div>

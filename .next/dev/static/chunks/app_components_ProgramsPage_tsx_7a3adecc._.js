...
"[project]/app/components/ProgramsPage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProgramsPage() {
    ...
    const blob1Ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const blob2Ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProgramsPage.useEffect": ()=>{
            // --- 3D TILT EFFECT ---
            const tiltCards = document.querySelectorAll('.tilt-card');
            tiltCards.forEach({
                "ProgramsPage.useEffect": (card)=>{
                    const htmlCard = card;
                    htmlCard.addEventListener('mousemove', {
                        "ProgramsPage.useEffect": (e)=>{
            ...
            registerBtns.forEach({
                "ProgramsPage.useEffect": (btn)=>{
                    const button = btn;
                    button.addEventListener('click', {
                        "ProgramsPage.useEffect": function() {
                            ...
                            setTimeout({
                                "ProgramsPage.useEffect": ()=>{
                                    ...
                                    }["ProgramsPage.useEffect"], 2000);
                                }
                            }["ProgramsPage.useEffect"], 1500);
                        }
                    }["ProgramsPage.useEffect"]);
                }
            }["ProgramsPage.useEffect"]);
            ...
            const parallaxObserver = new IntersectionObserver({
                "ProgramsPage.useEffect": (entries)=>{
                    entries.forEach({
                        "ProgramsPage.useEffect": (entry)=>{
            ...
            document.querySelectorAll('section').forEach({
                "ProgramsPage.useEffect": (section)=>{
            ...
            }["ProgramsPage.useEffect"], observerOptions);
            document.querySelectorAll('.reveal').forEach({
                "ProgramsPage.useEffect": (el)=>observer.observe(el)
            }["ProgramsPage.useEffect"]);
        }
    }["ProgramsPage.useEffect"], []);
...
_s(ProgramsPage, "dkUN0lPUmESRvJWfkTPcl/s3qmY=");
_c = ProgramsPage;
var _c;
...
//# sourceMappingURL=app_components_ProgramsPage_tsx_7a3adecc._.js.map